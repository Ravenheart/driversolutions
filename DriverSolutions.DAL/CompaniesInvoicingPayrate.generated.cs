...
{
	[Table("companies_invoicing_payrate")]
	[ConcurrencyControl(OptimisticConcurrencyControlStrategy.Changed)]
	[KeyGenerator(KeyGenerator.Autoinc)]
	public partial class CompaniesInvoicingPayrate : INotifyPropertyChanged
	{
		private uint _companyInvoicingID;
		[Column("CompanyInvoicingID", OpenAccessType = OpenAccessType.Int32, IsBackendCalculated = true, IsPrimaryKey = true, Length = 0, Scale = 0, SqlType = "integer unsigned")]
		[Storage("_companyInvoicingID")]
		public virtual uint CompanyInvoicingID
		{
			get
			{
				return this._companyInvoicingID;
			}
			set
			{
				if(this._companyInvoicingID != value)
				{
					this._companyInvoicingID = value;
					this.OnPropertyChanged("CompanyInvoicingID");
				}
			}
		}
		...
		[ForeignKeyAssociation(ConstraintName = "FK_companies_invoicing_payrate_companies_CompanyID", SharedFields = "CompanyID", TargetFields = "CompanyID")]
		[Storage("_company")]
